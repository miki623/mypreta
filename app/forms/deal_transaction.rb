class DealTransaction
  ...
  attr_accessor :buyer_id, :item_id, :postal_code, :shipping_area_id, :city, :house_number, :building_name, :phone_number, :token
  ...
  def save
    deal = Deal.create(buyer_id: buyer_id, item_id: item_id)
